...
SWITCH_longrun  activate reform with behavioral effects
;
********************************************************************************
*****                      Set model switches                              *****
********************************************************************************
SWITCH_DetL0     =       0; !! before environmental tax reform, but with
SWITCH_noredist  =       1; !! no redistribution, but a tax reform, gamma and sigma low
...
SWITCH_longrun   =       0; !! no redistribution, but tax reform and behavioral effects
...
GenEq(g),Utility,Welfare,Tax,AltTax1,AltTax2,Z_totaldef, X_totalconsdef, Inc_constraint,Dummy,GDPcalc,RealGDPcalc,Utility_NE,Welfare_NE
;
**********************************Firms*****************************************
FirmProd(g)..
...
HHFOC2,HHFOC3,GenEq,numeraire,Tax,Z_totaldef, X_totalconsdef,Inc_constraint,Utility,Utility_NE,Welfare_NE,Welfare,GDPcalc, RealGDPcalc/;
...
tau_P.fx  =        0.3;!!0.043;        !! fixed pre-existing carbon price (extraction cost or such)
...
!!$include "SG_calculate_ginis_etc.inc"
         execute_unload 'precali_before_cali.gdx';
         execute '=gdx2xls precali_before_cali.gdx';
)
...
!!$include "SG_calculate_ginis_etc.inc"
         execute_unload 'precal_after_noredist_arbejdslejr_cali.gdx';
         execute '=gdx2xls precal_after_noredist_arbejdslejr_cali.gdx';
);


if (SWITCH_longrun eq 1,
          Execute_loadpoint 'precali_before_ny.gdx';
...
!!$include "SG_calculate_ginis_etc.inc"
         execute_unload 'precal_after_noredist_longrun.gdx';
...
$call gdxmerge precali_before_ny.gdx precali_after_lumpanddiff.gdx precali_after_diff.gdx  precali_after_unif.gdx precali_after_lump.gdx precal_after_noredist_arbejdslejr.gdx precal_after_noredist_longrun.gdx
!!output=results.gdx;
