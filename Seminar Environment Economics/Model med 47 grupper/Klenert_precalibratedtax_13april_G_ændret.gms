...
!!Unp_gov        Unproductive government spending
...
gamma   = 0.2;   gov_spdg    = 6.3;  Unp_gov  = 1.3;
...
!! These alphas sum to 0.8 as far as we remember
...
!!$include "SG_calculate_ginis_etc.inc"
         execute_unload 'precali_before_G6_3.gdx';
       !!  execute '=gdx2xls precali_before_G6_3.gdx';
)

************   Solution for both diff. and lump-sum  ********************
if (SWITCH_Bench eq 1,

         Execute_loadpoint 'precali_before.gdx';
...
!!$include "SG_calculate_ginis_etc.inc"
         execute_unload 'precal_after_noredist_G6_3.gdx';
         execute '=gdx2xls precal_after_noredist_G6_3 .gdx';
);
