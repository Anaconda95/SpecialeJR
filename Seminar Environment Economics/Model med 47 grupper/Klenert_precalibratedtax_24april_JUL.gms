...
GenEq(g),Utility,Welfare,Tax,AltTax1,AltTax2,Z_totaldef, X_totalconsdef, Inc_constraint,Dummy,GDPcalc,Utility_NE,Welfare_NE
;
**********************************Firms*****************************************
FirmProd(g)..
...
HHFOC2,HHFOC3,GenEq,numeraire,Tax,Z_totaldef, X_totalconsdef,Inc_constraint,Utility,Utility_NE,Welfare_NE,Welfare,GDPcalc/;
model SG_ALTTAX /totalT,FirmProd,FirmFOC1,FirmFOC2,Copeland, HHFOC1,
HHFOC2,HHFOC3,GenEq,numeraire, AltTax1, AltTax2, Z_totaldef, X_totalconsdef,Inc_constraint,Utility,Utility_NE,Welfare_NE,Welfare/;
...
!!$include "SG_calculate_ginis_etc.inc"
        ...
        execute '=gdx2xls precal_after_noredist_longrun.gdx';
);
