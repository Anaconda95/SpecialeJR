...
SWITCH_diff      =       1; !! if this param is set to 1, revenue recycling occurs via differentiated income tax cuts
SWITCH_unif      =       1; !! if this param is set to 1, revenue recycling occurs via uniform income tax cuts
SWITCH_ULS       =       1; !! if this param is set to 1, revenues are recycled via uniform lump-sum transfers
Switch_Bench     =       1; !! after environmental tax reform (both lump-sum and income tax cuts)
