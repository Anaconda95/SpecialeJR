...
Gov(g)         Government consumption clean
...
FirmProd(g),totalT,FirmFOC1(g),FirmFOC2(g),Copeland(g),HHFOC1(i,g),HHFOC2(i),HHFOC3(i),numeraire,
...
********************************Government**************************************
Tax..
                         Gov_spdg =e=     (tau_p)*(Z_C+Z_D) + wage*sum(i,tau_w(i)*phi(i)*(T(i)-lei(i))) - 5*L; !!
