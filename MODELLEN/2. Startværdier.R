...
write.csv(likelihood2, "C:/specialeJR/Model Fit/LV_startv�rdier.csv")
write.csv(start_matstor1, "C:/specialeJR/Model Fit/startv�rdier.csv")
write.csv(bic_mat2, "C:/specialeJR/Model Fit/bic_startv�rdier.csv")
