...
write.csv(RMSE, "C:/specialeJR/Model Fit/RMSE_forecast.csv")


######### Laver figur der illustrerer forecast fra 2014-2019 #######
...
linetypes = c("Actual share" = "solid", 
...
p <- list()
for (i in 1:8) {
  v=data.frame(Year=c(2014:2019),ActualShare=faktisk_w[,i],M1=model1_w[,i],M2=model2_w[,i],
