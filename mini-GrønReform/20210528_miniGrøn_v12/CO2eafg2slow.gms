...
leakagerate(j) = 0;
*Kvæg
leakagerate('01000b') = 0.15;
*Svin
leakagerate('01000c') = 0.09;
*Olie
leakagerate('190000a') = 0.36;
*Kemikalier
leakagerate('200010') = 0.67;
leakagerate('200020') = 0.67;
*Cement
leakagerate('230020') = 0.56;
*Metal
leakagerate('240000') = 0.11;
*Elektricitet
leakagerate('350010a') = 0.12;

* * * * * Vælg : * * * * * * * *
*100 pct. lækagekorrektion for udvalgte brancher:
leakagerate(j)$(leakagerate(j)>0) = 1;

*Fradrag for alle brancher
...
s_CCS.fx(part,j) $ (d1KBpartX(part,j) eq 0) = 0;
...
*------------------------------------------------------------
* * * * * Den generelle CO2e-afgift hæves til 900 kr. per ton
*------------------------------------------------------------
set loopstep2(loopstep) /3*32/;
...
MACdata(loopstep2,'CO2eReduk') = 100-(CO2eDK.l+LULUCF2030)/CO2e_inklLULUCF_1990*100;
...
*------------------------------------------------------------
set loopstep4(loopstep) /100*209/;
...
loop(loopstep4 $ (CO2eDK.l GT (CO2emaal2030)),
*loop(loopstep4,
