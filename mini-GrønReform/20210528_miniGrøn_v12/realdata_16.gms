...
parameters
  ...
  Ktu73V(ns73)        "Capital stock - transport (1000 DKK)"  
...
* * * * * Ændringer i moms på privatforbrug start * * * * * *

* Momssatser i energibrancher korrigeres med oplysninger fra energistatistikken. Først tilpasses øvrige brancher, så det samlede provenu er uændret.

tVAT_cD.l(i) = (PC73V('nTv') - 9082585 - 4912732 - 951484)/ ((sum(jj,((1+sum(taxd,tDuty_cd.l(jj,taxd)))*cD.l(jj)+(1+sum(taxd,tDuty_cF.l(jj,taxd)))*(1+tCus_c.l(jj))*cF.l(jj)))
 -((1+sum(taxd,tDuty_cd.l('190000a',taxd)))*cD.l('190000a')+(1+sum(taxd,tDuty_cF.l('190000a',taxd)))*(1+tCus_c.l('190000a'))*cF.l('190000a'))
 -((1+sum(taxd,tDuty_cd.l('190000b',taxd)))*cD.l('190000b')+(1+sum(taxd,tDuty_cF.l('190000b',taxd)))*(1+tCus_c.l('190000b'))*cF.l('190000b'))
 -((1+sum(taxd,tDuty_cd.l('350010a',taxd)))*cD.l('350010a')+(1+sum(taxd,tDuty_cF.l('350010a',taxd)))*(1+tCus_c.l('350010a'))*cF.l('350010a'))
 -((1+sum(taxd,tDuty_cd.l('350010b',taxd)))*cD.l('350010b')+(1+sum(taxd,tDuty_cF.l('350010b',taxd)))*(1+tCus_c.l('350010b'))*cF.l('350010b'))
 -((1+sum(taxd,tDuty_cd.l('350020a',taxd)))*cD.l('350020a')+(1+sum(taxd,tDuty_cF.l('350020a',taxd)))*(1+tCus_c.l('350020a'))*cF.l('350020a'))
 -((1+sum(taxd,tDuty_cd.l('350020b',taxd)))*cD.l('350020b')+(1+sum(taxd,tDuty_cF.l('350020b',taxd)))*(1+tCus_c.l('350020b'))*cF.l('350020b'))
 -((1+sum(taxd,tDuty_cd.l('350030a',taxd)))*cD.l('350030a')+(1+sum(taxd,tDuty_cF.l('350030a',taxd)))*(1+tCus_c.l('350030a'))*cF.l('350030a'))
 -((1+sum(taxd,tDuty_cd.l('350030b',taxd)))*cD.l('350030b')+(1+sum(taxd,tDuty_cF.l('350030b',taxd)))*(1+tCus_c.l('350030b'))*cF.l('350030b'))
 -((1+sum(taxd,tDuty_cd.l('383900',taxd)))*cD.l('383900')+(1+sum(taxd,tDuty_cF.l('383900',taxd)))*(1+tCus_c.l('383900'))*cF.l('383900')))*1000000);
tVAT_cF.l(i) = tVAT_cD.l(i); 

tVAT_cD.l('190000a') = 4912732 / (((1+sum(taxd,tDuty_cd.l('190000a',taxd)))*cD.l('190000a')+(1+sum(taxd,tDuty_cF.l('190000a',taxd)))*(1+tCus_c.l('190000a'))*cF.l('190000a'))*1000000);
tVAT_cF.l('190000a') = tVAT_cD.l('190000a');

tVAT_cD.l('190000b') = 0;
tVAT_cF.l('190000b') = tVAT_cD.l('190000b');

tVAT_cD.l('350010a') = 9082585 / (((1+sum(taxd,tDuty_cd.l('350010a',taxd)))*cD.l('350010a')+(1+sum(taxd,tDuty_cF.l('350010a',taxd)))*(1+tCus_c.l('350010a'))*cF.l('350010a')
 +(1+sum(taxd,tDuty_cd.l('350010b',taxd)))*cD.l('350010b')+(1+sum(taxd,tDuty_cF.l('350010b',taxd)))*(1+tCus_c.l('350010b'))*cF.l('350010b')
 +(1+sum(taxd,tDuty_cd.l('350030a',taxd)))*cD.l('350030a')+(1+sum(taxd,tDuty_cF.l('350030a',taxd)))*(1+tCus_c.l('350030a'))*cF.l('350030a')
 +(1+sum(taxd,tDuty_cd.l('350030b',taxd)))*cD.l('350030b')+(1+sum(taxd,tDuty_cF.l('350030b',taxd)))*(1+tCus_c.l('350030b'))*cF.l('350030b')
 +(1+sum(taxd,tDuty_cd.l('383900',taxd)))*cD.l('383900')+(1+sum(taxd,tDuty_cF.l('383900',taxd)))*(1+tCus_c.l('383900'))*cF.l('383900'))*1000000);
tVAT_cF.l('350010a') = tVAT_cD.l('350010a');

tVAT_cD.l('350010b') = tVAT_cD.l('350010a');
tVAT_cF.l('350010b') = tVAT_cD.l('350010a');
tVAT_cD.l('350030a') = tVAT_cD.l('350010a');
tVAT_cF.l('350030a') = tVAT_cD.l('350010a');
tVAT_cD.l('350030b') = tVAT_cD.l('350010a');
tVAT_cF.l('350030b') = tVAT_cD.l('350010a');
tVAT_cD.l('383900') = tVAT_cD.l('350010a');
tVAT_cF.l('383900') = tVAT_cD.l('350010a');

tVAT_cD.l('350020a') = 951484 / (((1+sum(taxd,tDuty_cd.l('350020a',taxd)))*cD.l('350020a')+(1+sum(taxd,tDuty_cF.l('350020a',taxd)))*(1+tCus_c.l('350020a'))*cF.l('350020a'))*1000000);
tVAT_cF.l('350020a') = tVAT_cD.l('350020a');

tVAT_cD.l('350020b') = 0;
tVAT_cF.l('350020b') = tVAT_cD.l('350020b');

Parameter testVAT;
testVAT = PC73V('nTv') - ((sum(jj, (tVAT_cD.l(jj)*(1+sum(taxd,tDuty_cd.l(jj,taxd)))*cD.l(jj)+tVAT_cF.l(jj)*(1+sum(taxd,tDuty_cF.l(jj,taxd)))*(1+tCus_c.l(jj))*cF.l(jj))))*1000000);

Display tVAT_cD.l, testVAT;

* * * * * Ændringer i moms på privatforbrug slut * * * * * *
...
parameter testd;
testd(j,i)$x.l(j,i) = (1+sum(taxd,tDuty_xD.l(j,i,taxd)));
display testd;
...
parameter testm;
testm(j,'tot') = ((1+tVAT_ILD.l(j))*(1+sum(taxd,tDuty_ILD.l(j,taxd))));
testm(j,'vat') = tVAT_ILD.l(j);
testm(j,'duty') = sum(taxd,tDuty_ILD.l(j,taxd));
display testm;
*HACK
tDuty_ILD.l('230010',taxd) = 0;
...
CH.l('neELEL') = CH.l('350010a')+CH.l('350010b');
CH.l('neReno') = CH.l('383900');
CH.l('neEL') = CH.l('neELEL')+CH.l('neReno');
CH.l('neGAS')  = CH.l('350020a')+CH.l('350020b');
CH.l('neFV')  = CH.l('350030a')+CH.l('350030b');
CH.l('neV')  = CH.l('neGAS')+CH.l('neFV');
CH.l('ne') = CH.l('neEL') + CH.l('neV'); 

CH.l('nf6') = CH.l('100010a')+CH.l('100010b');
CH.l('nf5') = CH.l('nf6')+CH.l('100010c');
CH.l('nf4') = CH.l('nf5')+CH.l('100020');
CH.l('nf3') = CH.l('nf4')+CH.l('100030');
CH.l('nf2') = CH.l('nf3')+CH.l('100040');
CH.l('nf1') = CH.l('nf2')+CH.l('100050');
CH.l('nf')  = CH.l('nf1')+CH.l('11200');

CH.l('a4') = CH.l('01000b')+CH.l('01000c');
CH.l('a3') = CH.l('a4')+CH.l('01000d');
CH.l('a2') = CH.l('a3')+CH.l('030000');
CH.l('a1') = CH.l('a2')+CH.l('01000a');
CH.l('a')  = CH.l('a1')+CH.l('020000');
