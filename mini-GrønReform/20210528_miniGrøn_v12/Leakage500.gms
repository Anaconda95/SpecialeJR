...
CO2eTax_dummyE('01000a',kilder,udled_type) = CO2eTax_dummyE('01000a',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('01000a',udled_type)= CO2eTax_dummyIE('01000a',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('01000b',kilder,udled_type) = CO2eTax_dummyE('01000b',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('01000b',udled_type)= CO2eTax_dummyIE('01000b',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('01000d',kilder,udled_type) = CO2eTax_dummyE('01000d',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('01000d',udled_type)= CO2eTax_dummyIE('01000d',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('190000a',kilder,udled_type) = CO2eTax_dummyE('190000a',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('190000a',udled_type)= CO2eTax_dummyIE('190000a',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('200010',kilder,udled_type) = CO2eTax_dummyE('200010',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('200010',udled_type)= CO2eTax_dummyIE('200010',udled_type) + 500/CO2eTax.l;
CO2eTax_dummyE('200020',kilder,udled_type) = CO2eTax_dummyE('200020',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('200020',udled_type)= CO2eTax_dummyIE('200020',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('200010',kilder,udled_type) = CO2eTax_dummyE('200020',kilder,udled_type) - 500/CO2eTax.l;
CO2eTax_dummyIE('200010',udled_type)= CO2eTax_dummyIE('200020',udled_type) - 500/CO2eTax.l;
CO2eTax_dummyE('200020',kilder,udled_type) = CO2eTax_dummyE('200020',kilder,udled_type) - 500/CO2eTax.l;
CO2eTax_dummyIE('200020',udled_type)= CO2eTax_dummyIE('200020',udled_type) - 500/CO2eTax.l;
...
*Cement
$ontext
CO2eTax_dummyE('230020',kilder,udled_type) = CO2eTax_dummyE('230020',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('230020',udled_type)= CO2eTax_dummyIE('230020',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('240000',kilder,udled_type) = CO2eTax_dummyE('240000',kilder,udled_type) + 300/CO2eTax.l;
CO2eTax_dummyIE('240000',udled_type)= CO2eTax_dummyIE('240000',udled_type) + 300/CO2eTax.l;

solve static_fremskriv using cns;

CO2eTax_dummyE('240000',kilder,udled_type) = CO2eTax_dummyE('240000',kilder,udled_type) + 200/CO2eTax.l;
CO2eTax_dummyIE('240000',udled_type)= CO2eTax_dummyIE('240000',udled_type) + 200/CO2eTax.l;
...
CO2eTax_dummyE('350010a',kilder,udled_type) = CO2eTax_dummyE('350010a',kilder,udled_type) + 300/CO2eTax.l;
CO2eTax_dummyIE('350010a',udled_type)= CO2eTax_dummyIE('350010a',udled_type) + 300/CO2eTax.l;

solve static_fremskriv using cns;

CO2eTax_dummyE('350010a',kilder,udled_type) = CO2eTax_dummyE('350010a',kilder,udled_type) + 200/CO2eTax.l;
CO2eTax_dummyIE('350010a',udled_type)= CO2eTax_dummyIE('350010a',udled_type) + 200/CO2eTax.l;
...
CO2eTax_dummyE('Industri',kilder,udled_type) = CO2eTax_dummyE('Industri',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('Industri',udled_type)= CO2eTax_dummyIE('Industri',udled_type) + 500/CO2eTax.l;
...
CO2eTax_dummyE('Tjenester',kilder,udled_type) = CO2eTax_dummyE('Tjenester',kilder,udled_type) + 500/CO2eTax.l;
CO2eTax_dummyIE('Tjenester',udled_type)= CO2eTax_dummyIE('Tjenester',udled_type) + 500/CO2eTax.l;
